...
public final class EasyHttp {
    ...
    private static final int DEFAULT_RETRY_INCREASEDELAY = 200;       //默认重试叠加时间
    private static final int DEFAULT_RETRY_DELAY = 1000;              //默认重试延时
    ...
    public EasyHttp debug(String tag, boolean isPrintException) {
        String tempTag = TextUtils.isEmpty(tag) ? "http_" : tag;
        if (isPrintException) {
