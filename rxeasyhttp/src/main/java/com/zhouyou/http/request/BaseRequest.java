...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    ////------
    protected JSONObject jsons = null;
     ...
     * 设置参数(以json的格式)
     */
    public R json(JSONObject jsons) {
        this.jsons = jsons;
        return (R) this;
    }

    public R json(String key, String value) {
        if (jsons == null) {
    ...
    public R json(String key, int value) {
        if (jsons == null) {
            jsons = new JSONObject();
        }
        try {
    ...
    public R json(String key, boolean value) {
        if (jsons == null) {
            jsons = new JSONObject();
        }
        try {
    ...
    public R json(String key, Object value) {
        if (jsons == null) {
            jsons = new JSONObject();
        }
        try {
    ...
    public R json(String key, double value) {
        if (jsons == null) {
            jsons = new JSONObject();
        }
        try {
